...
This file provides guidelines for Copilot, Claude, and other AI agents
contributing to ParleyJS.

## Project Overview

ParleyJS is a JavaScript framework for inter-window communication that
simplifies and extends the native `postMessage` API. The framework prioritizes:
...
**IMPORTANT**: All documentation and code comments must follow
DOCUMENTATION_STYLE_GUIDE.md. Review this file before writing any documentation.

**IMPORTANT**: All documentation navigation must follow
DOCUMENTATION_NAVIGATION_STRATEGY.md for cross-linking, breadcrumbs, and user
navigation.
...
Wrong: "✓ Test passed" Correct: "Test passed"

Wrong: "Error in origin validation" Correct: "Origin validation failed"

### Language Quality Standards

1. **Natural and Human-Readable**
    - Write as you would explain to a colleague
    - Use active voice (prefer "ParleyJS validates origin" not "origin is
      validated")
    - Be direct and clear
...
1. **No Markdown Files Unless Explicitly Asked**
    ...
    - If you create temporary markdown files (checklists, plans), you MUST
      delete them before completing the task
    - Exception: Only create `.md` files when explicitly requested by the
      developer
