[Home](../README.md) > [Documentation](./README.md) > Testing Patterns
...
describe('request-response', () => {
  ...
  it('should match response to request', async () => {
    ...
    const response = await parley.send('calculate', { x: 5, y: 3 }, {
      targetId: 'child'
    });
...
describe('iFrame communication', () => {
  ...
  it('should establish bidirectional communication', async () => {
    ...
    const response = await parentParley.send('greeting', {
