[Home](../../index.md) > [Documentation](./index.md) > Patterns
...
This section provides battle-tested patterns for common scenarios. These
patterns are production-ready and follow best practices for security, error
handling, and performance.

Unlike guides which focus on specific use cases, patterns are reusable building
blocks you can adapt to any scenario.
...
Use patterns when you need a specific solution. Use guides when you need
complete implementation steps.

## Related Sections

- **[Guides](../guides/index.md)** - Use-case specific implementations
